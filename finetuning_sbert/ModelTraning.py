...
def create_evaluation_data(
    ...
    for idx, row in eval_df.iterrows():
        ...
        # Allow multiple relevant documents per query
...
def initialize_model(model_name: str, pooling_mode: str = "max") -> SentenceTransformer:
    ...
    model = SentenceTransformer(
        ...
        model_card_data=SentenceTransformerModelCardData(
            ...
            dataset_size="",  # TODO: Add dataset size
        ),
    )
    return model
